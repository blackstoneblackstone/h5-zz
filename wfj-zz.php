...
class JSSDK {
    ...
    private function getJsApiTicket() {
        ...
        if ($data->expire_time < time()) {
            ...
            if ($ticket) {
                ...
                $this->saveData("zz_jsapi_ticket.json",  json_encode($data));
            }
        } else {
    ...
    private function getAccessToken() {
        $data = json_decode($this->loadData("zz_access_token.json", '{"access_token":"", "expire_time": 0}'));
        if ($data->expire_time < time()) {
            ...
            if ($access_token) {
                ...
                $this->saveData("zz_access_token.json", json_encode($data));
            }
        } else {
...
$appID = "wx6a7da1d2770a17a0";
$appSecret = "ee04d6255fd45e366a0650411e1c6839";
